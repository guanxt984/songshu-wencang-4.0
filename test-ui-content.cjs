...
[
  ...
  ["Toolbar does not use a stable three-column layout", expandedToolbarCssSource, "grid-template-columns: repeat(3, minmax(125.4px, 1fr))"],
  ...
  ["Toolbar icon box does not use a fixed 38px width", toolbarIconBoxCssSource, "width: 34.2px"],
  ["Toolbar icon box does not use a fixed 38px height", toolbarIconBoxCssSource, "height: 34.2px"],
  ["Toolbar lacks a keyboard focus treatment", cssSource, ".bottom-toolbar button:focus-visible"],
  ["Toolbar width is not reduced by 5 percent", expandedToolbarCssSource, "width: min(608px, calc(95% - 53.2px))"],
  ["Toolbar height is not reduced by 5 percent", expandedToolbarCssSource, "min-height: 62.7px"],
  ["Perched mascot is not reduced by 10 percent", toolbarMascotCssSource, "width: 153px"],
  ["Toolbar icons are not reduced by 10 percent", toolbarIconBoxCssSource, "flex: 0 0 34.2px"],
...
[
  ...
  ["Narrow toolbar icon box is not compact", narrowToolbarCssSource, "flex: 0 0 16.2px"],
